...
func (c *Client) getEth2Config() (Eth2ConfigResponse, error) {
	response := Eth2ConfigResponse{}
	response.Data = Data{10, 10, 10}
	return response, nil
...
func (c *Client) getEth2DepositContract() (Eth2DepositContractResponse, error) {
	address := common.HexToAddress("0x789a5FDac2b37FCD290fb2924382297A6AE65860")
	type Data struct {
		ChainID uinteger       `json:"chain_id"`
		Address common.Address `json:"address"`
	}

	eth2DepositContractResponse := Eth2DepositContractResponse{Data{uinteger(43112), address}}
	return eth2DepositContractResponse, nil
